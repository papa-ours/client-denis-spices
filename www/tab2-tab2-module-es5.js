...
var Tab2Page = /** @class */ (function () {
    function Tab2Page(toastController, service, router) {
    ...
    Tab2Page.prototype.showToast = function () {
    ...
    Tab2Page.prototype.onSubmit = function (changeView) {
        var _this = this;
        if (changeView === void 0) { changeView = false; }
        if (this.spice.label === "") {
            this.showToast();
            return;
        }
        this.service.createSpice(this.spice).subscribe(function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!changeView) return [3 /*break*/, 1];
    ...
    Tab2Page.prototype.updateLabel = function ($event) {
        this.spice.label = $event.detail.value;
    };
    Tab2Page.prototype.updateType = function ($event) {
